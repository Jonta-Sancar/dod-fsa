#  🚀 WORKSHOP DEVOPS - Configurando ambiente do zero
...
Configure o arquivo `build-publish.yaml`:
```yaml
name: Build & Publish
...
* [ver vídeo](https://www.awesomescreenshot.com/video/47283466?key=4290a2972cbb1bad25c1a311debde690)
